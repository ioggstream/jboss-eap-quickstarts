helloworld-ws: Hello World JAX-WS Web Service + CXF Interceptors
==================================================
Author: Roberto Polli  
Level: Beginner  
Technologies: JAX-WS, CXF
Summary: Deployment of a JAX-WS Web service with CXF Interceptors bundled in a WAR archive  
Target Product: EAP  
...
This example demonstrates the use of *JAX-WS* and *CXF Interceptors* in Red Hat JBoss Enterprise Application Platform as a simple Hello World application, without any deployment descriptors.
