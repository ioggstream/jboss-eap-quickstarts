...
==========================================================================
Author: Gustavo A. Brey, Gaston Coco, Roberto Polli  
Level: Intermediate  
Technologies: CDI, JAX-RS, Spring and Aspectj 
Summary: Demonstrates the use of Spring, CDI 1.0 and JAX-RS  
Target Product: EAP  
...
This example demonstrates the use of *CDI 1.0*, *JAX-RS* and *Spring* in Red Hat JBoss Enterprise Application Platform.
...
The *XML* content can be viewed by accessing the following URL: <http://localhost:8080/jboss-helloworld-rs-spring/rest/xml> 

The *JSON* content can be viewed by accessing this URL: <http://localhost:8080/jboss-helloworld-rs-spring/rest/json>

The *Spring* and aspectj handler is properly setup if opening the following commands prints all the contens of injected variables:

    #curl http://localhost:8080/jboss-helloworld-rs-spring/rest/spring
    {
        "CDI":"Hello World!",
        "springBean":"CiaoAspected",
        "springContext":"Root WebApplicationContext: startup date [Tue Sep 16 14:15:11 UTC 2014]; root of context hierarchy"
    }

The Aspectj filter appends "Aspected" to the default response "Ciao" defined in a spring bean.
